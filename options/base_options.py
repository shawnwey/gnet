...
class BaseOptions():
    def __init__(self):
        ...
        self.dataroot = [r'F:\ggy\CNNDetectionDataset', '/home/disk/weixing/datasets/deepfake_database']

    def initialize(self, parser):
        parser.add_argument('--env', type=int, default=0)
        parser.add_argument('--gpu', type=int, default=0)
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--name', type=str, default='baseline', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--classes', default='person', help='image classes to train on')
    ...
    def parse(self, print_options=True):
        ...
        # args update
        opt.dataroot = self.dataroot[opt.env]   # 'path to images (should have subfolders trainA, trainB, valA, valB, etc)'
